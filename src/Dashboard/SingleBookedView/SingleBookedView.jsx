...
const SingleBookedView = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await axios.get(`https://hotelboking.herokuapp.com/order/bookedRoom/${hotel}`)
                // const res = await axios.get(`https://hotelboking.herokuapp.com/hotel/room/${hotel}`)
                setData(res.data)
            } catch (err) {
                console.log(err)
            }
